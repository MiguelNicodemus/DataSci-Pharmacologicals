# Projeto `Avaliação do impacto de fatores pré-definidos em diferentes indicadores de doenças respiratórias (Covid 19, H1N1, Influenza, Pneumonia, SARS e MERS) no ano de 2020`
